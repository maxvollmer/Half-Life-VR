...
void CGrenade::Killed(entvars_t*, int bitsDamageType, int) { }
...
int CBasePlayer::GiveAmmo(int iCount, const char* szName, int iMax, int* pIndex /* = nullptr*/) { return 0; }
...
CBaseEntity* CBasePlayerItem::Respawn(void) { return nullptr; }
