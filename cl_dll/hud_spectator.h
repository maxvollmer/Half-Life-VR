...
private:
	...
	HSPRITE_VALVE		m_hsprPlayerBlue;
	HSPRITE_VALVE		m_hsprPlayerRed;
	HSPRITE_VALVE		m_hsprPlayer;
	HSPRITE_VALVE		m_hsprCamera;
	HSPRITE_VALVE		m_hsprPlayerDead;
	HSPRITE_VALVE		m_hsprViewcone;
	HSPRITE_VALVE		m_hsprUnkownMap;
	HSPRITE_VALVE		m_hsprBeam;
	HSPRITE_VALVE		m_hCrosshair;
