...
void CWorld::Precache(void)
{
	...
	//pSoundEnt = CBaseEntity::Create<CBaseEntity>( "soundent", g_vecZero, g_vecZero, edict() );
	...
	if (pev->netname)
	{
		...
		CBaseEntity* pEntity = CBaseEntity::Create<CBaseEntity>("env_message", g_vecZero, g_vecZero, nullptr);
		if (pEntity)
		{
