...
{
	{tlIdleStopShooting,
	 (int)std::size(tlIdleStopShooting),
	 bits_COND_NEW_ENEMY |
		 bits_COND_LIGHT_DAMAGE |
		 bits_COND_HEAVY_DAMAGE |
		 bits_COND_HEAR_SOUND,
...
Schedule_t slTlkIdleWatchClient[] =
{
	{tlTlkIdleWatchClient,
	 (int)std::size(tlTlkIdleWatchClient),
	 bits_COND_NEW_ENEMY |
		 bits_COND_LIGHT_DAMAGE |
		 bits_COND_HEAVY_DAMAGE |
		 bits_COND_HEAR_SOUND |
	...
	{tlTlkIdleWatchClientStare,
	 (int)std::size(tlTlkIdleWatchClientStare),
	 bits_COND_NEW_ENEMY |
		 bits_COND_LIGHT_DAMAGE |
		 bits_COND_HEAVY_DAMAGE |
		 bits_COND_HEAR_SOUND |
...
{
	{tlTlkIdleEyecontact,
	 (int)std::size(tlTlkIdleEyecontact),
	 bits_COND_NEW_ENEMY |
		 bits_COND_CLIENT_PUSH |
		 bits_COND_LIGHT_DAMAGE |
		 bits_COND_HEAVY_DAMAGE,
