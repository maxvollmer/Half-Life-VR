    ...
    public class HLVRModSettings : ISettingsContainer
    {
        ...
        public OrderedDictionary<I18N.I18NString, OrderedDictionary<string, Setting>> InputSettings = new OrderedDictionary<I18N.I18NString, OrderedDictionary<string, Setting>>()
        {
            { new I18N.I18NString("InputSettings.AntinauseaFeatures", "Anti-nausea features"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_semicheat_spinthingyspeed", Setting.Create( new I18N.I18NString("vr_semicheat_spinthingyspeed", "Set maximum speed for those fast spinning platforms near the tentacle monster (map c1a4f) (game default: 110, mod default: 50)"), SettingType.SPEED, "50" ) },
            ...
            { new I18N.I18NString("InputSettings.MovementSpeed", "Movement Speed"), new OrderedDictionary<string, Setting>() {
            ...
            { new I18N.I18NString("InputSettings.ControlsAndAccessibility", "Controls & Accessibility"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_ledge_pull_speed", Setting.Create( new I18N.I18NString("vr_ledge_pull_speed", "Minimum controller speed to trigger ledge pulling"), SettingType.SPEED, "50" ) },
            ...
            { new I18N.I18NString("InputSettings.Movement", "Movement"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_rl_duck_height", Setting.Create( new I18N.I18NString("vr_rl_duck_height", "Real-life crouch height"), SettingType.DISTANCE, "100" ) },
            ...
            { new I18N.I18NString("InputSettings.Ladders", "Ladders"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_ladder_legacy_movement_speed", Setting.Create( new I18N.I18NString("vr_ladder_legacy_movement_speed", "Climb speed on ladders (legacy movement)"), SettingType.SPEED, "100" ) },
            } },
            ...
            { new I18N.I18NString("InputSettings.MountedGuns", "Mounted guns"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_tankcontrols_max_distance", Setting.Create( new I18N.I18NString("vr_tankcontrols_max_distance", "Maximum controller distance to gun for immersive controls"), SettingType.DISTANCE, "128" ) },
        ...
        public OrderedDictionary<I18N.I18NString, OrderedDictionary<string, Setting>> AudioSettings = new OrderedDictionary<I18N.I18NString, OrderedDictionary<string, Setting>>()
        {
            { new I18N.I18NString("AudioSettings.FMOD", "FMOD"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_fmod_wall_occlusion", Setting.Create( new I18N.I18NString("vr_fmod_wall_occlusion", "Wall occlusion (how much sound gets blocked by walls in %)"), SettingType.COUNT, "40" ) },
                { "vr_fmod_door_occlusion", Setting.Create( new I18N.I18NString("vr_fmod_door_occlusion", "Door occlusion (how much sound gets blocked by doors in %)"), SettingType.COUNT, "30" ) },
                { "vr_fmod_water_occlusion", Setting.Create( new I18N.I18NString("vr_fmod_water_occlusion", "Water occlusion (how much sound gets blocked by water in %)"), SettingType.COUNT, "20" ) },
                { "vr_fmod_glass_occlusion", Setting.Create( new I18N.I18NString("vr_fmod_glass_occlusion", "Glass occlusion (how much sound gets blocked by glass in %)"), SettingType.COUNT, "10" ) },
            } },
            ...
            { CategorySpeechRecognition, new OrderedDictionary<string, Setting>() {
                ...
                { SpeechRecognitionLanguage, Setting.Create( new I18N.I18NString("SpeechRecognitionLanguage", "Language"), new OrderedDictionary<string, I18N.I18NString>(){ { "1400", new I18N.I18NString("vr_speech_language_id.1400", "System Default") } }, "1400" ) },
        ...
        public OrderedDictionary<I18N.I18NString, OrderedDictionary<string, Setting>> OtherSettings = new OrderedDictionary<I18N.I18NString, OrderedDictionary<string, Setting>>()
        {
            { new I18N.I18NString("OtherSettings.AdvancedHUD", "Advanced HUD"), new OrderedDictionary<string, Setting>() {
                ...
                { "vr_hud_ammo_offset_x", Setting.Create( new I18N.I18NString("vr_hud_ammo_offset_x", "HUD ammo display offset X"), SettingType.COUNT, "3" ) },
                { "vr_hud_ammo_offset_y", Setting.Create( new I18N.I18NString("vr_hud_ammo_offset_y", "HUD ammo display offset Y"), SettingType.COUNT, "-3" ) },

                { "vr_hud_flashlight_offset_x", Setting.Create( new I18N.I18NString("vr_hud_flashlight_offset_x", "HUD flashlight display offset X"), SettingType.COUNT, "-5" ) },
                { "vr_hud_flashlight_offset_y", Setting.Create( new I18N.I18NString("vr_hud_flashlight_offset_y", "HUD flashlight display offset Y"), SettingType.COUNT, "-2" ) },

                { "vr_hud_health_offset_x", Setting.Create( new I18N.I18NString("vr_hud_health_offset_x", "HUD health display offset X"), SettingType.COUNT, "-4" ) },
                { "vr_hud_health_offset_y", Setting.Create( new I18N.I18NString("vr_hud_health_offset_y", "HUD health display offset Y"), SettingType.COUNT, "-3" ) },
            } },
