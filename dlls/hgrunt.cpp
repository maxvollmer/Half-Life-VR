...
{
	{tlGruntCombatFail,
	 (int)std::size(tlGruntCombatFail),
	 bits_COND_CAN_RANGE_ATTACK1 |
		 bits_COND_CAN_RANGE_ATTACK2,
	 0,
	 "Grunt Combat Fail"},
...
{
	{tlGruntVictoryDance,
	 (int)std::size(tlGruntVictoryDance),
	 bits_COND_NEW_ENEMY |
...
Schedule_t slGruntEstablishLineOfFire[] =
{
	{tlGruntEstablishLineOfFire,
	 (int)std::size(tlGruntEstablishLineOfFire),
	 bits_COND_NEW_ENEMY |
...
{
	{tlGruntFoundEnemy,
	 (int)std::size(tlGruntFoundEnemy),
	 bits_COND_HEAR_SOUND,
...
{
	{tlGruntCombatFace1,
	 (int)std::size(tlGruntCombatFace1),
	 bits_COND_NEW_ENEMY |
		 bits_COND_ENEMY_DEAD |
		 bits_COND_CAN_RANGE_ATTACK1 |
		 bits_COND_CAN_RANGE_ATTACK2,
...
Schedule_t slGruntSignalSuppress[] =
{
	{tlGruntSignalSuppress,
	 (int)std::size(tlGruntSignalSuppress),
	 bits_COND_ENEMY_DEAD |
		 bits_COND_LIGHT_DAMAGE |
		 bits_COND_HEAVY_DAMAGE |
		 bits_COND_HEAR_SOUND |
...
{
	{tlGruntWaitInCover,
	 (int)std::size(tlGruntWaitInCover),
	 bits_COND_NEW_ENEMY |
		 bits_COND_HEAR_SOUND |
		 bits_COND_CAN_RANGE_ATTACK1 |
		 bits_COND_CAN_RANGE_ATTACK2 |
...
{
	{tlGruntTakeCover1,
	 (int)std::size(tlGruntTakeCover1),
	 0,
	 0,
	 "TakeCover"},
};
...
Schedule_t slGruntGrenadeCover[] =
{
	{tlGruntGrenadeCover1,
	 (int)std::size(tlGruntGrenadeCover1),
	 0,
	 0,
	 "GrenadeCover"},
};
...
Schedule_t slGruntTossGrenadeCover[] =
{
	{tlGruntTossGrenadeCover1,
	 (int)std::size(tlGruntTossGrenadeCover1),
	 0,
	 0,
	 "TossGrenadeCover"},
};
...
Schedule_t slGruntTakeCoverFromBestSound[] =
{
	{tlGruntTakeCoverFromBestSound,
	 (int)std::size(tlGruntTakeCoverFromBestSound),
	 0,
	 0,
...
{
	{tlGruntHideReload,
	 (int)std::size(tlGruntHideReload),
	 bits_COND_HEAVY_DAMAGE |
		 bits_COND_HEAR_SOUND,
...
Schedule_t slGruntRangeAttack1A[] =
{
	{tlGruntRangeAttack1A,
	 (int)std::size(tlGruntRangeAttack1A),
	 bits_COND_NEW_ENEMY |
		 bits_COND_ENEMY_DEAD |
		 bits_COND_HEAVY_DAMAGE |
...
Schedule_t slGruntRangeAttack1B[] =
{
	{tlGruntRangeAttack1B,
	 (int)std::size(tlGruntRangeAttack1B),
	 bits_COND_NEW_ENEMY |
		 bits_COND_ENEMY_DEAD |
		 bits_COND_HEAVY_DAMAGE |
		 bits_COND_ENEMY_OCCLUDED |
...
{
	{tlGruntRangeAttack2,
	 (int)std::size(tlGruntRangeAttack2),
	 0,
	 0,
	 "RangeAttack2"},
};
...
{
	{tlGruntRepelAttack,
	 (int)std::size(tlGruntRepelAttack),
	 bits_COND_ENEMY_OCCLUDED,
	 0,
	 "Repel Attack"},
};
...
void CHGruntRepel::RepelUse(CBaseEntity* pActivator, CBaseEntity* pCaller, USE_TYPE useType, float value)
{
	...
	*/
	...
	CBaseMonster* pGrunt = CBaseEntity::Create<CBaseMonster>("monster_human_grunt", pev->origin, pev->angles);
